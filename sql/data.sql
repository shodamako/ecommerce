...
insert into order_items(id,item_id,order_id,quantity) values(1,1,1,10);
insert into order_items(id,item_id,order_id,quantity) values(2,2,2,10);

insert into orders(id,order_number,user_id,status,total_price,date) values(1,'20150824000001',1,1,100000,'2015-08-24');
insert into orders(id,order_number,user_id,status,total_price,date) values(2,'20150824000002',2,3,5000,'2015-08-24');
